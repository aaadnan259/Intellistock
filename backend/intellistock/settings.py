...
# Database
# Use DB connection from environment for Docker
DB_NAME = config('POSTGRES_DB', default='intellistock')
...
# CORS
CORS_ALLOW_ALL_ORIGINS = True # Simplified for MVP/Container comms, can be tightened
